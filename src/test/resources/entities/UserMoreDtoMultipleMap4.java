...
@CassitoryEntity(target = {User.class, UserByName.class}, destinationPackage = "entities.repositories", consistencyLevel = ConsistencyLevel.ALL, tracing = true)
public class UserMoreDtoMultipleMap4 {
